...
public class MzLipidCandidate extends Utilities implements Comparable<MzLipidCandidate>
{
	...
	//Constructor
	public MzLipidCandidate(Lipid lipid)
	{
	...
	public int compareTo(MzLipidCandidate lc)
	{
		int result = 0;
